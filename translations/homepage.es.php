...
return [
    ...
    'step_4' => 'Hay una primera sección, Parámetros Comunes, donde estableces parámetros como el servidor de nombres, sufijo de dominio, rutas de certificados SSL, formatos de log, etc., que luego se usan como base para los nuevos Vhosts.',
    'step_5' => 'Luego, está la sección de Parámetros relacionados con el Tipo de Vhost, donde estableces los parámetros necesarios relacionados con el tipo de vhost.',
    'step_6' => 'Hay una sección opcional para un bloque Extra, donde puedes introducir directivas o bloques de Nginx arbitrarios, que se adjuntarán al final de la configuración.',
    ...
    'generate_specific_vhost_text' => 'Siendo <code>mi-vhost</code> el nombre que le has dado a un vhost creado en la base de datos, puedes usar',
